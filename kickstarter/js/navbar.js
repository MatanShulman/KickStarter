...
function onLogIn(userName, link) {
	loginLink = link;
	$('.navbar-right').html(' <div class="userAccount form-group disable" style="color: white;margin-right: 27px;"> Hello: ' + userName + '</div>' +
									    ...
									    '<ul class="dropdown-menu" role="menu" aria-labelledby="menu1">'+ 
									    	'<li role="presentation">' +
												'<form id="navabarForm" method="post" action="projectForm.php">' +
													...
													'<a role="menuitem" tabindex="-1" onclick="document.getElementById(\'navabarForm\').submit();" style="cursor: pointer;">Create-Project</a>' +
												'</form>' +
								    		'</li>'+ 
								    		'<li role="presentation"><a role="menuitem" tabindex="-1" href="manageProject.php">My Projects</a></li>'+ 
									    	'<li role="presentation" class="divider"></li>'+ 
									    	'<li role="presentation"><a role="menuitem" tabindex="-1" onclick="showAboutBox()">About Us</a></li>'+ 
									    '</ul>'+ 
								  	'</div>');
	}
									    ...
									    '<ul class="dropdown-menu" role="menu" aria-labelledby="menu1">'+ 
									    	'<li role="presentation">' +
												'<form id="createProjectForm" method="post" action="projectForm.php">' +
													'<input type="hidden" name="projectId" value="-1"/>' +
													'<a role="menuitem" tabindex="-1" onclick="document.getElementById(\'createProjectForm\').submit();" style="cursor: pointer;">Create-Project</a>' +
												'</form>' +
								    		'</li>'+ 
	...
	var navbar = 	'<div class="container">' +
						'<div class="navbar-header">' +
							'<button type="button" class="navbar-toggle collapsed"' +
								...
								'<span class="icon-bar"></span>' +
							'</button>' +
							'<a class="navbar-brand" href="#">Kickstarter Project</a>' +
						'</div>' +
...
function showAboutBox() {
	var title = "<h3><b><center>About Us</center></b></h3>";
	var box = "<p>&copy; Matan Shulman & Oren Yulzary</p>";
	showModal(title, box);
}
