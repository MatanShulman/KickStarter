	...
	if (confirm("Are you Sure you want to donate  " + donateSum +"$") == true){ 
		...
		$.post("php/insertDonate.php", {data: myJsonObject},
			function (data, textStatus) {
				...
				var body = "<p>Thanks  you  for your donation of money!</p>";
				showModal(title, body);
			}
		);
	}
					...
					"<div class='col-md-4'>"+
						"<div class='row'>"+
							...
							"<div class='col-md-12' style='margin-top: 20px;'>"+
								"<a onclick='donate()' class='btn btn-lg btn-success donate_btn'>Donate</a>"+
							"</div>"+
						"</div>"+
					"</div>"+
				"</div>";
...
function appendRewardForDonate(json) {
	...
	body += 	'<center><h3>or just press  <button onclick="donateMoney()" style="font-size: 15px;" class="btn btn-lg btn-warning"> HERE </button>  to donate any amount </h3></center>'
